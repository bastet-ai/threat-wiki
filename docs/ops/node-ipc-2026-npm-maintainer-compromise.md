...
## Sources
- Socket: [https://socket.dev/blog/node-ipc-package-compromised](https://socket.dev/blog/node-ipc-package-compromised)
- Snyk: [https://snyk.io/blog/malicious-node-ipc-versions-published-npm/](https://snyk.io/blog/malicious-node-ipc-versions-published-npm/)
- Snyk advisory: [https://security.snyk.io/vuln/SNYK-JS-NODEIPC-16697063](https://security.snyk.io/vuln/SNYK-JS-NODEIPC-16697063)
