...
## Sources
- Socket: [https://socket.dev/blog/npm-pypi-campaign-typosquats-popular-secure-payment-apps](https://socket.dev/blog/npm-pypi-campaign-typosquats-popular-secure-payment-apps)
