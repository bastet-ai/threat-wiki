...
## Sources
- Socket Security Research: [https://socket.dev/blog/152-chrome-live-wallpaper-extensions-hid-ad-tracking](https://socket.dev/blog/152-chrome-live-wallpaper-extensions-hid-ad-tracking)
