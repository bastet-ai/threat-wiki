...
- **Linux infection chain:** RCE → web shell → LPE via **CVE-2022-0995** (watch_queue), **CVE-2021-3156** (Baron Samedit), **CVE-2015-5287** (ABRT sosreport), **CVE-2015-3246** (libuser roothelper), **CVE-2010-3904** (RDS), and **CVE-2022-0847** (Dirty Pipe) → deploys Noodle RAT, SPECTRE, and Meterpreter. As of **August 26, 2026** CISA has added **CVE-2021-23758, CVE-2022-0995, CVE-2015-5287, and CVE-2015-3246** to its Known Exploited Vulnerabilities catalog — independently confirming these as known-exploited with BOD 26-04 deadlines (see the [CISA KEV August 26 batch page](cisa-kev-citrix-sql-server-august-26-2026.md); CISA names no actor; the UAT-10147 linkage here is Talos' attribution).
...
- [CISA KEV August 26 batch: four UAT-10147 CVEs confirmed known-exploited](cisa-kev-citrix-sql-server-august-26-2026.md)
