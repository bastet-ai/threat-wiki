...
## Sources
- Wiz: [https://www.wiz.io/blog/threat-actors-target-crypto-orgs](https://www.wiz.io/blog/threat-actors-target-crypto-orgs)
- StepSecurity Velora DEX SDK coverage: [https://www.stepsecurity.io/blog/velora-dex-sdk-compromised-on-npm-malicious-version-drops-macos-backdoor-via-launchctl-persistence](https://www.stepsecurity.io/blog/velora-dex-sdk-compromised-on-npm-malicious-version-drops-macos-backdoor-via-launchctl-persistence)
- iru MINIRAT coverage: [https://www.iru.com/blog/minirat](https://www.iru.com/blog/minirat)
