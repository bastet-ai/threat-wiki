...
- **Socket Security Research** — https://socket.dev/blog (HTML watch; prior RSS paths returned 404/403 in current checks; watch Shai-Hulud/Mini Shai-Hulud variants, registry-response notices such as npm token invalidation, TeamPCP/copycat reporting, cross-ecosystem Packagist/Composer and GitHub source-repository compromises, RubyGems abuse such as GemStuffer, and AI-toolchain supply-chain tradecraft such as MCP or coding-assistant poisoning)
